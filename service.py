...
class Handler(BaseHTTPRequestHandler):
    ...
    def download_audio_and_video(self, ytdl_opts, url, filename):
        ...
        try:
            ...
            video_filename_with_ext = f"{filename}_{id}_{video_file['format_id']}.{video_file['ext']}"
            audio_filename_with_ext = f"{filename}_{id}_{audio_file['format_id']}.{audio_file['ext']}"
